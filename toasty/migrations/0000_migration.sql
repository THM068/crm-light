...
CREATE INDEX "index_users_by_account_id" ON "users" ("account_id");
CREATE INDEX "index_users_by_username_lower" ON "users" ("username_lower");
...
CREATE INDEX "index_activities_by_account_id" ON "activities" ("account_id");
...
CREATE INDEX "index_deals_by_account_id" ON "deals" ("account_id");
...
CREATE INDEX "index_contacts_by_account_id" ON "contacts" ("account_id");
...
CREATE INDEX "index_companies_by_account_id" ON "companies" ("account_id");
...
CREATE UNIQUE INDEX "index_accounts_by_slug" ON "accounts" ("slug");
...
CREATE INDEX "index_login_attempts_by_account_id" ON "login_attempts" ("account_id");
CREATE INDEX "index_login_attempts_by_username_lower" ON "login_attempts" ("username_lower");
